...
``AlertSource.name`` default of ``"abandoned-object"``. The SDK
...
# This process is the abandoned-object app — see module docstring.
set_default_source(kind="app", name="abandoned-object", version="1.0.0")
