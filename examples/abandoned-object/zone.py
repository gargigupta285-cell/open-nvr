...
This file used to hold the ray-casting point-in-polygon zone math
(copied verbatim from ``examples/intrusion-detection/zone.py`` per the
old copy-as-template model). Per §08 step 1 of the App SDK spec, the
