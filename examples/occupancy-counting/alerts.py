...
``AlertSource.name`` default of ``"occupancy-counting"``. The SDK
...
# This process is the occupancy-counting app — see module docstring.
set_default_source(kind="app", name="occupancy-counting", version="1.0.0")
