...
- **Replay** — KAI-C's NATS broker is fire-and-forget. Events fired while no subscriber is listening are lost. Durable consumers / replay land with a separate event-store slice (B2).
